...
11. Click on the `Commit new file` button
...
15. We want to pull edits from the head repository (i.e. your forked repository) to the base repository (`chrisdaaz/recipe-bookdown`). In the drop-down menu for "head repository", select your fork: `[YOUR_USERNAME]/recipe-bookdown`
...
17. You have the option to label the pull request, or you can use the auto-populated information (this information comes from step 9 above).
